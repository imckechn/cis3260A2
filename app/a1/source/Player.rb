class Player
	def count_coins_in_bag
		@bag.count_coins
	end

	def count_dice_in_bag
		@bag.count_dice
	end

	def count_coins_in_cup
		@cup.count_coins
	end

	def count_dice_in_cup
		@cup.count_dice
	end
	...
	# Puts all objects into the players bag
	...
	def serialize
		...
		#Put all objects in the players bag
		replace()

		#now serialize everything in the bag and return it
		@bag.serialize_all
	end

	def unserialize_all(data)
		@bag.unserialize_all(data)
	end
