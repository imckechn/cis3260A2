...
// Generated by dart2js (NullSafetyMode.sound, trust primitives, omit checks, lax runtime type, deferred-serialization, csp), the Dart to JavaScript compiler version: 2.18.1.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _updateComponents($arguments, adjust, change, scale) {
      ...
      if (t1 !== 0)
        throw A.wrapException(A.SassScriptException$("No " + A.pluralize("argument", t1, _null) + " named " + A.S(A.toSentence(keywords.get$keys(keywords).map$1$1(0, new A._updateComponents_closure(), type$.Object), "or")) + ".", _null));
    ...
    _updateComponents0($arguments, adjust, change, scale) {
      ...
      t1 = keywords.__js_helper$_length;
      if (t1 !== 0)
        throw A.wrapException(A.SassScriptException$0("No " + A.pluralize0("argument", t1, _null) + " named " + A.S(A.toSentence0(keywords.get$keys(keywords).map$1$1(0, new A._updateComponents_closure0(), type$.Object), "or")) + ".", _null));
      hasRgb = red != null || green != null || blue != null;
      hasSL = saturation != null || lightness != null;
      hasWB = whiteness != null || blackness != null;
      if (hasRgb)
    ...
    _checkAngle0(angle, $name) {
      ...
      if (angle.compatibleWithUnit$1("deg")) {
        t3 = type$.JSArray_String;
        t2 = t1 + ("You're passing " + angle.toString$0(0) + string$.x2c_whici + A.SassNumber_SassNumber0(angle._number1$_value, "deg").toString$0(0) + ".\n") + (string$.Soon__ + angle.coerce$2(A._setArrayType(["deg"], t3), A._setArrayType([], t3)).toString$0(0) + ".\n") + "\n" + (t2 + " * 1deg/1" + B.JSArray_methods.get$first(angle.get$numeratorUnits(angle)) + "\n") + ("To migrate to new behavior: 0deg + $" + $name + "\n") + "\n";
        t1 = t2;
      } else
        t1 = t1 + (t2 + A._removeUnits0(angle) + "\n") + "\n";
      t1 += "See https://sass-lang.com/d/color-units";
